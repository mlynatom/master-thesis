...
HF_MODEL_ID="/mnt/personal/mlynatom/thesis_models/it-Llama-3.1-8B-Instruct-full_mix_11_cs_en/merge_16bit" # example model id 
MODEL_PRETTY_NAME="B+IT->IT_(cs+en)" # example model name
